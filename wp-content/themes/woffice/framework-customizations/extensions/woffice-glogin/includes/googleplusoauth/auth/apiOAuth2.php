...
class apiOAuth2 extends apiAuth {
  ...
  public $redirectUri;
  public $state;
  /*See : http://stackoverflow.com/questions/28052155/always-have-offline-access-google-oauth-2*/
  ...
  public function __construct() {
    ...
    if (! empty($apiConfig['oauth2_client_id'])) {
        ...
        $this->clientId = str_replace(' ', '', $apiConfig['oauth2_client_id']);
    }

    if (! empty($apiConfig['oauth2_client_secret'])) {
        // We remove white spaces :
        $this->clientSecret = str_replace(' ', '', $apiConfig['oauth2_client_secret']);
    }
