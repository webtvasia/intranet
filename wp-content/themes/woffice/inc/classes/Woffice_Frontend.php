    ...
    class Woffice_Frontend
    {
        ...
        static function frontend_process( $type, $post_id = 0, $is_shortcode = false ) {
            ...
            elseif ( $type == 'project' ) {
                ...
                $project_completed         = ( isset( $_POST['project_completed'] ) && $_POST['project_completed'] == 'yes' ) ? true : false;
                ...
                fw_set_db_post_option( $post_id, 'project_completed', $project_completed );
...
//                }
                    ...
                    $html .= '<span class="wpcf7-checkbox">';
                        $html .= '<span class="wpcf7-list-item">';
                            $html .= '<label class="frontend-checkbox '.$project_todo_class.'">';
                                ...
                                $html .= '<span class="wpcf7-list-item-label">'. __( "Enable project Tasks ?", "woffice" ). '</span>';
                            $html .= '</label>';
                        $html .= '</span>';
                    $html .= '</span>';
                    $html .= '</p>';
	            ...
	            if( woffice_current_user_can_complete_project($post_id) ) {
		            $project_completed_val = (!empty($post_id) ) ? woffice_get_post_option($post_id, 'project_completed', false) : false;
		            $project_completed_checked = ($project_completed_val) ? 'checked="checked"' : '';
		            $project_completed_class = ($project_completed_val) ? 'checked' : '';
		            $html .= '<p>';
		                $html .= '<span class="wpcf7-checkbox">';
		                    $html .= '<span class="wpcf7-list-item">';
		                        $html .= '<label class="frontend-checkbox '.$project_completed_class.'">';
		                            $html .= '<input type="checkbox" name="project_completed" id="project_completed" value="yes" '.$project_completed_checked.'>';
                                    $html .= '<span class="wpcf7-list-item-label">'. __( "The project is completed", "woffice" ) .'</span>';
		                        $html .= '</label>';
		                    $html .= '</span>';
		                $html .= '</span>';
		            $html .= '</p>';
